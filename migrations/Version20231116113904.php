 ...
 */
final class Version20231116113904 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD id INT AUTO_INCREMENT NOT NULL, DROP id_entreprise, DROP nom, DROP prenom, DROP pdp, DROP num, DROP mail, DROP mdp1, DROP role, DROP adresse, DROP genre, DROP logo, DROP nom_entreprise, DROP secteur, DROP description, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_292FFF1DAF38ABEA ON vehicule (libellet_vehicule)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD id_entreprise INT NOT NULL, ADD nom VARCHAR(20) DEFAULT NULL, ADD prenom VARCHAR(25) DEFAULT NULL, ADD pdp VARCHAR(200) NOT NULL, ADD num INT NOT NULL, ADD mail VARCHAR(20) NOT NULL, ADD mdp1 VARCHAR(30) NOT NULL, ADD role VARCHAR(20) NOT NULL, ADD adresse VARCHAR(50) NOT NULL, ADD genre VARCHAR(30) NOT NULL, ADD logo VARCHAR(200) NOT NULL, ADD nom_entreprise VARCHAR(20) NOT NULL, ADD secteur VARCHAR(40) NOT NULL, ADD description VARCHAR(30) NOT NULL, DROP id');
        ...
        $this->addSql('DROP INDEX UNIQ_292FFF1DAF38ABEA ON vehicule');
    }
}
